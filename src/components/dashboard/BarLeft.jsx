    ...
    return (
        <nav className="w-50 h-screen flex flex-col justify-between items-center">            
            ...
            <div className="w-full">
                ...
                <NavIcon><BsBoxArrowLeft color="black"/><span className="text-gradient">Cerrar sesión</span></NavIcon>
            </div>
            <div className="w-[80%] flex-1 justify-center items-center content-center">
                <CreateEntry><BsPlusCircleFill color="#2fba87" size={32} /><h2 className="text-center text-[#2fba87]">Agregar</h2></CreateEntry>
            </div>
        </nav>
    )
}